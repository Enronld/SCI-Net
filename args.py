...
def _add_common_args(arg_parser):
    ...
    arg_parser.add_argument('--rel_filter_threshold', type=float, default=0.5, help="Filter threshold for relations")
    arg_parser.add_argument('--size_embedding', type=int, default=25, help="Dimensionality of size embedding")
    arg_parser.add_argument('--head', type=int, default=1, help="attention head")
