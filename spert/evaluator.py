...
class Evaluator:
    ...
    def compute_scores(self):
        ...
        print("")
        print("--- Term Extraction (Aspect Term Extraction & Opinion Term Extraction) ---")
        print("An term is considered correct if the term type and span is predicted correctly. Subject means Aspect, while Opinion means Opinion")
        print("")
        ...
        def convert(t):
            if not include_entity_types:
                ...
                if type(t[0]) == int:  # entity
                    c = [t[0], 0, self._pseudo_entity_type]
                    # c = [t[0], self._pseudo_entity_type]
